...
We used [LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) v0.X.X. Replace XXX\template.py file with the one in this repository to use the same format for system, input, and output prompts in our paper.
...
Eun Cheol Choi, Ashwing Balasubramanian, Jinhu Qi, Emilio Ferrara. 2025. Limited efficiency of LLM-generated data augmentation in COVID-19 misinformation stance detection. In Companion Proceedings of the ACM Web Conference 2025 (WWW ’25 Companion), Apr 28–May 2, 2025, Sydney, Australia. ACM, New York, NY, USA, 4 pages. https://doi.org/XXX
